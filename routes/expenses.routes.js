...
import {addExpenseValidator, updateExpenseValidator, validateHandler} from "../utils/validators.js";
...
// Update an expense
router.put("/:id", updateExpenseValidator(), validateHandler, updateExpense);
