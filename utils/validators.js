...
const registerValidator = () => [
    ...
    body("gender").optional().isIn(["male", "female"]).withMessage("Provide a correct one"),
];
...
const addExpenseValidator = () => [
    ...
    body("participants.*.percentage")
        ...
        .custom((value, { req }) => {
            ...
            if (splitMethod === "percentage" && value === undefined) {
                throw new Error("Percentage is required for 'percentage' split method");
            }
            return true;
        }),
];
